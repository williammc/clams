...
protected:
  ...
  std::vector< std::shared_ptr<openni_wrapper::Image> > image_buffer_;
  std::vector< std::shared_ptr<openni_wrapper::DepthImage> > depth_buffer_;
  bool quitting_;

  cv::Mat3b oniToCV(const openni_wrapper::Image& oni) const;
  void idiCallback(const std::shared_ptr<openni_wrapper::Image>& img,
...
void Inspector::run()
{
  ...
  boost::function<void (const std::shared_ptr<openni_wrapper::Image>&,
...
void Inspector::idiCallback(const std::shared_ptr<openni_wrapper::Image>& img,
                            const std::shared_ptr<openni_wrapper::DepthImage>& depth,
                            float constant)
{
  lock();
